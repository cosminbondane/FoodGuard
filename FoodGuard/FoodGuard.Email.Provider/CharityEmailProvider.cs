...
namespace FoodGuard.Email.Provider
{
    public class CharityEmailProvider
    {
        ...
        public void StartForAll()
        {
            ...
            //    EmailHelper.SendAsHtml<object>("New Offer", "no-reply@foodguard.com", charity.Email, "New Offer", x);
            //}
        }

        public void StartForOne(string toEmail)
        {
            EmailHelper.SendAsHtml<object>("New Offer", "no-reply@foodguard.com", toEmail, "Welcome to FoodGuard", new object());
        }
    }
}
